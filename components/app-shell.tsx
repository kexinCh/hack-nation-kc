...
export function AppShell({
  ...
  return (
    <div className="min-h-screen bg-[#f8f6f0] text-[#1f2933]">
      <a
        href="#main-content"
      ...
      <header className="border-b border-[#d8d0bf] bg-[#fffdf7]">
        <div className="mx-auto flex max-w-6xl flex-col gap-4 px-4 py-4 sm:px-6 lg:flex-row lg:items-center lg:justify-between">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.16em] text-[#6b5b3f]">
              {t.browserLocalDemo}
            </p>
            <p className="text-lg font-semibold text-[#172026]">{t.productName}</p>
            <p className="text-sm text-[#52616b]">{housingProgram.metroName}</p>
          </div>
            ...
            {navItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  className={cn(
                    "rounded-md px-3 py-2 text-sm font-medium text-[#334e68] outline-none transition focus-visible:ring-3 focus-visible:ring-[#2f80ed]/40",
                    active
      ...
      <footer className="border-t border-[#d8d0bf] bg-[#fffdf7]">
